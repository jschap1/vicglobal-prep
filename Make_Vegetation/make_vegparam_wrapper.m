...
addpath(genpath('/hdd/VICGlobal/06_Software/00_VICMATLAB/VICMATLAB_old'))
addpath('/hdd/VICGlobal/06_Software/07_Software_Archive');

% for code archiving purposes
outdir_archive = '/hdd/VICGlobal/06_Software/07_Software_Archive';
...
modisfile = '/hdd/Data/MODIS_LC/MCD12C1.A2017001.006.2019192025407.hdf';
...
fID = fopen('/hdd/VICGlobal/03_Vegetation_Parameters/Global/igbp_classnames.txt');
...
resampled_modis_dir = outdir_archive;
for k=1:nclasses
...
soilfile = '/hdd/VICGlobal/07_Archive/v1.6c/Classic/soils_3L_MERIT.txt';
...
cropped_modis_dir = '/hdd/VICGlobal/07_Archive/v1.6c/Classic/soils_3L_MERIT.txt';
% cropped_modis_dir = '/Volumes/HD3/VICParametersGlobal/VICGlobal/v1_5/Classic';
maskfile = '/hdd/Data/MERIT/merged_merit_v1/merged_merit_v1/merged_merit_mask_1_16.tif';
...
VEGPARAMS = convert_veg_parameters(nvegtable, vegparamtable, latlontable, veglib, LC, outdir, plotflag, saveflag);
